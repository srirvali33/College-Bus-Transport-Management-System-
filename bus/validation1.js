...
if(Reg.Hall_Ticket_No.value.length=="")
    {
...
if(Reg.Hall_Ticket_No.value.length < 7 || Reg.Hall_Ticket_No.value.length > 10 || Reg.Hall_Ticket_No.value.search(/[^0-9\-()+]/g) != -1 )
				{
				alert("Hall_Ticket_No Must be Greater Than 7 or 10 Digits and Phno Must be numeric value except(+,(),-)");
				Reg.Hall_Ticket_No.focus();
				Reg.Hall_Ticket_No.value.value="";
				return false;
}
