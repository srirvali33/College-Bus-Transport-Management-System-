...
<!---************************** Session Starts ********************************************************-->	
  ...
  <h1>College Wise Enroll List</h1>
...
<b>College Code (any 4 Characters) </b>  
<input type="text" name="Remarks2" size="10" maxlength="20" />
:  
...
if (isset($_REQUEST['edit'])) {
	...
	$Remarks2=strtoupper($_POST["Remarks2"]);
...
<h3> College Code <?php echo  $Remarks2." "; ?>  Route_No</h3>
...
<?php
$Sno=0;
$result12 = mysql_query("SELECT * FROM `studentregistration` WHERE `Remarks2` LIKE '%$Remarks2%' ORDER BY `Remarks1`, `Rout_No`, `Bus_Stage_Name` ASC");
