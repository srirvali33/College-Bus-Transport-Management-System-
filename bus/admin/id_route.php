...
<body >
  ...
  <?php 
$result12 = mysql_query("SELECT * FROM `studentregistration` WHERE `Rout_No` LIKE '%$Route_No%' and  `Account_Status` like '%$FormSubmissionDetails%' and Remarks3 ='' ORDER BY `studentregistration`.`Rout_No` ASC ");
...
<table width="363" height="191" >
  <tr>
    <td height="58" colspan="3"><img src="index_files/engclg.jpg" width="350" height="56" style="
