...
<!---************************** Session Starts ********************************************************-->	
  ...
  <h1>Student Name wise Search</h1>


<form action=""  method="post" name="Reg" onSubmit="return ValidateForm(this)">


<b>Student Name(any 4 Characters) </b>  
<input type="text" name="StudentName" size="10" maxlength="20" />
:  
...
<?php
$Sno=0;
$result12 = mysql_query("SELECT * FROM `studentregistration` WHERE `Name_Student` LIKE '%$StudentName%' ORDER BY `Name_Student`, `Rout_No`, `Bus_Stage_Name` ASC");
...
?>
<td  align="center"><img src="photos/<?php echo $row['Hall_Ticket_No']; ?>.jpg" width="68" height="83">
</td>
